...
public interface ISurface : ISdlWrapper<IntPtr>
{
    ...
    /// <value>Write a single pixel to the surface. </value>
    public Color this[Vector2 position] { set; }
    ...
    public ISurface Convert(SDL.PixelFormat format);

    /// <summary>Return a copy of a surface rotated clockwise a number of degrees.</summary>
    public ISurface Rotate(float degree);
}
